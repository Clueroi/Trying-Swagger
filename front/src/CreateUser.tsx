...
import { z } from "zod"
import { getGetUsersQueryKey, useCreateUser } from "./http/generated/api"
...
export function CreateUser() {
  ...
  return (
    <form onSubmit={handleSubmit(handleCreateUser)} action="">
      <input type="text" id="" {...register('name')} />
      {errors.name && <span>{errors.name.message}</span>}
      <button type="submit" value="">Criar usário</button>
    </form>
  )
}